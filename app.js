...
function crearElementoTarjeta({ id, titulo, descripcion, categoria }) {
  ...
  tarjeta.dataset.id = id; // Se asegura de usar el atributo data-id
...
galeria.addEventListener("click", (e) => {
  ...
  // Corrección: Se agregó el guion en data-id para coincidir con el atributo
  ...
  btn.addEventListener("click", () => {
    ...
    todasLasTarjetas.forEach((tarjeta) => {
      if (categoriaFiltro === "todas") {
        ...
        // Se corrigió el salto de línea que rompía el string de la clase
...
function actualizarContador() {
  ...
  // Manejo del mensaje de galería vacía
  const mensajeExistente = galeria.querySelector(".mensaje-vacio");
...
// Inicializar el estado de la galería al cargar
actualizarContador();
